...
# Viewing Logs
./logs.sh                           # View worldserver logs (default)
./logs.sh ac-authserver             # View authserver logs
./logs.sh ac-database               # View database logs

# Backing Up Databases
./sqldump.sh --backup               # Create a backup
./sqldump.sh --list                 # List available backups
./sqldump.sh --restore 2024-01-15   # Restore from a backup (YYYY-MM-DD format)
